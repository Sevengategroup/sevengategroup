...
import { n as Route$2 } from "./router-Dr_yIcMN.mjs";
import { c as ArrowLeft } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/details._slug-Bnja6Xhq.js
...
var serviceDetails = [
	...
	},
	{
		...
		fullContent: ["End-to-end mine development and operational management, applying rigorous engineering standards and sustainable practices to extract value efficiently and safely."]
	},
	{
		...
		fullContent: ["Advanced processing solutions designed to maximize yield and purity, leveraging state-of-the-art technology to ensure high-grade mineral output for global markets."]
	},
	{
		...
		fullContent: ["Collaborating with leading global technical partners to build local capability, transfer specialized knowledge, and establish world-class mining operations in Nigeria."]
	},
	{
		slug: "upstream",
		...
		fullContent: ["Supporting exploration and production operations with OEM equipment supply, technical services, and maintenance solutions that maximise production uptime and asset integrity."]
	},
	{
		slug: "midstream",
		categoryTitle: "Oil & Gas Services",
		...
		fullContent: ["Providing pipeline services, procurement support, and technical expertise to operators managing transportation, storage, and processing infrastructure."]
	},
	{
		slug: "downstream",
		categoryTitle: "Oil & Gas Services",
		...
		fullContent: ["Delivering inspection, maintenance, and equipment supply services to refining and distribution facilities, ensuring regulatory compliance and operational continuity."]
	},
	{
		...
		fullContent: ["We provide end-to-end conventional power solutions that ensure reliable electricity generation, transmission, and distribution. Our services include engineering, procurement, construction, operation, maintenance, rehabilitation, and optimization of thermal and gas-fired power plants, helping clients achieve maximum operational performance and energy security.", "With extensive industry experience, we focus on improving plant efficiency, reducing downtime, and extending the lifespan of critical assets. By integrating proven technologies with sound engineering practices, we deliver dependable power solutions that support industrial growth, national development, and sustainable economic progress."]
	},
	{
		slug: "green-energy",
		categoryTitle: "Power Sector Services",
	...
	},
	{
		...
		fullContent: ["Our manufacturing and distribution operations are built on a commitment to quality, innovation, and operational excellence. We produce and supply high-quality industrial products, equipment, and engineered solutions that meet international standards and support the diverse needs of clients across multiple industries.", "Supported by a reliable logistics and supply chain network, we ensure timely delivery of products while maintaining consistent quality and customer satisfaction. Our integrated approach allows us to respond quickly to market demands, optimize efficiency, and create lasting value for our clients and partners."]
	}
];
var getServiceDetailBySlug = (slug) => {
...
function ServiceDetailComponent() {
	...
	if (!detail) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "pt-8 md:pt-12 pb-16 md:pb-24 container-x max-w-4xl mx-auto",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
							variants: fadeInUp,
							className: "flex flex-col gap-6 text-muted-foreground font-light leading-relaxed md:text-lg",
							children: detail.fullContent.map((paragraph, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: paragraph }, index))
						})
					]
				})
			}),
...
//#endregion
export { ServiceDetailComponent as component };
